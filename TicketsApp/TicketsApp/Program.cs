    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            var engine = new MarketingEngine(events, new VerifierFactory(events));
            engine.SendCustomerNotifications(customer);

            Console.WriteLine();
            engine.SendCustomerNotifications(customer, NotificationType.CloseToBirthDay);

            Console.WriteLine();
            engine.SendCustomerNotifications(customer, NotificationType.CloseToCustomer);
